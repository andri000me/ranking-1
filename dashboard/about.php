      ...
      <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto">
        ...
        <div class="row">
          <div class="col-lg-10 offset-lg-1">
            <hr>
            <p>This application was made within 3 days due to time constraints, therefore if there are bugs in the application,<br>report it <a href="mailto:rudihikmatullah@outlook.com">rudihikmatullah@outlook.com</a></p>
            <h4>Thanks to</h4>
            <div class="row">
